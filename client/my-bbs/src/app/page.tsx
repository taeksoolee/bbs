...
import { faAngleLeft, faAngleRight, faAnglesLeft, faAnglesRight, faArrowLeft } from '@fortawesome/free-solid-svg-icons'
    ...
    <main className="mt-10">
      <div className="">
        <table className="border-2 border-primary mx-auto shadow-sm">
          ...
          <thead>
            <tr class="bg-primary-active text-light">
          ...
          <tbody>
            <tr className="text-dark text-center bg-white hover:bg-primary-active hover:text-light hover:opacity-40 cursor-pointer">
              <td className='border-2 border-primary-200'>1</td>
              <td className='border-2 border-primary-200 pl-4'>Apple Color is Red!</td>
              <td className='border-2 border-primary-200'>2023-05-02</td>
            </tr>
          </tbody>
        </table>
      </div>
